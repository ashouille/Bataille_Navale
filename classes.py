...
class Plateau:
    ...
    def print_tab(self):
        ...
        letter = "A"
        for point_x in range(self.size):
    ...
    def _place_is_valid(self, inp, boat):
        ...
        if (
            self.horizontal
            and self.x_pos + boat.lenght > self.size
            or not self.horizontal
            and self.y_pos + boat.lenght > self.size
        ):
            return False
    ...
    def play_position(self, computer_tab, inp, ship_list):
